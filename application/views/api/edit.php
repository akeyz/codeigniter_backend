                            ...
                            <div class="portlet-body form">
                                <?php echo form_open('', array('class' => 'form-horizontal')); ?>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="name" value="<?php echo $row['name']; ?>" data-rule-required="true" data-msg-required="请填写API名称" class="span6 m-wrap"/>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="controller" value="<?php echo $row['controller']; ?>" data-rule-required="true" data-msg-required="请填写API控制器" class="span6 m-wrap"/>
                                            <span class="help-inline"></span>
                                        </div>
                                    </div>
                                    <div class="control-group">
