                            ...
                            <div class="portlet-body form">
                                <?php echo form_open('', array('class' => 'form-horizontal')); ?>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="name" data-rule-required="true" data-msg-required="请填写授权名称" value="<?php echo $row['name']; ?>" class="span6 m-wrap"/>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="key" value="<?php echo $row['key']; ?>" class="span6 m-wrap" readonly />
                                            <span class="help-inline"></span>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                            ...
                                            <?php if (isset($controllers)): ?>
                                                <?php foreach ($controllers as $controller): ?>
                                                    <label class="checkbox line">
                                                        <input type="checkbox" name="controller[]" value="<?php echo $controller['controller']; ?>" data-rule-required="true" data-msg-required="请选择授权控制器" <?php if( strpos($row['controller'], $controller['controller']) !== false ){ echo "checked='checked'"; } ?> />
