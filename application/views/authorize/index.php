                ...
                <div class="span12">
                    <div class="portlet">
                        <div class="portlet-title">
                            <?php echo anchor('authorize/index', '授权key列表', array('class' => 'btn blue')); ?>
                            <?php echo anchor('authorize/create', '新建授权key', array('class' => 'btn green')); ?>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <?php if (isset ($rows)): ?>
                                    <?php foreach ($rows as $row): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo anchor('authorize/edit/'.$row['id'], lang('edit'), array('class' => 'btn purple mini')); ?>
                                                ...
                                                <div id="static<?php echo $row['id']; ?>" class="modal hide fade" tabindex="-1" data-backdrop="static<?php echo $row['id']; ?>" data-keyboard="false">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <?php echo anchor('authorize/delete/'.$row['id'], lang('delete'), array('class' => 'btn red')); ?>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
